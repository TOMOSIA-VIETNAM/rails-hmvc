export default {
  ...
  hero: {
    ...
    painPoints: {
      ...
      p1_desc: 'このボイラープレートは、実績のある構造で「アーキテクチャ地獄」からあなたを救い、確実に動作します。',
      p2: 'エラーループを自動的に防ぐRailwayパターン',
      p2_desc: '同じモデルがエンドポイントごとに異なるバリデーションルールを必要とする場合、このボイラープレートは、アプリを静かに壊してしまう重複バリデーションの悪夢を防ぎます。',
      p3: '概念優先の組織化で配置の推測が不要になります',
      p3_desc: 'コードベースが大きくなるにつれ、デバッグは地獄の宝探しのようになります。私たちのボイラープレートの明確な階層化アーキテクチャにより、問題を数日ではなく数分で特定・修正できます。'
    }
  },
  knowledgeBanner: {
